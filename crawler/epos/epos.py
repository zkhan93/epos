...
def _fetch_rc_details_epds(rc_number="10310060087015900096", dist_code="233"):
...
def get_rc_details_from_epds(
    ...
    if not data:
        content = _fetch_rc_details_epds(rc_number=rc_number, dist_code=dist_code)
